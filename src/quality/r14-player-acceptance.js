(function(C){
  ...
  C.R14PlayerAcceptance={VERSION,VIEWPORTS,viewportSize,modeFor,visible,rect,firstRun,sync,audit,closeCompetingPanel,settleRenderer,install};if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',install,{once:true});else install();
