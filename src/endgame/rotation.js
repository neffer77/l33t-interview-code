(function(C){
  ...
  class EndgameRotation{
    ...
    onInterviewer(e){const s=this.currentStage();return s?.type==='reasoning'&&s.challengeId===e.challenge?.id?this.completeStage('reasoning',e.record?.score||0,{challengeId:e.challenge.id}):false}
