...
(() => {
  ...
  function decorate(el){
    ...
    const sync=()=>{pre.innerHTML=tokenize(el.value||'');pre.scrollTop=el.scrollTop;pre.scrollLeft=el.scrollLeft;};
    el.addEventListener('input',sync);el.addEventListener('scroll',sync);sync();
  }
  ...
  const style=document.createElement('style');style.textContent=`.phase43-code-wrap{position:relative}.phase43-code-wrap textarea,.phase43-highlight{box-sizing:border-box;margin:0!important;width:100%;font:inherit;line-height:inherit;tab-size:4;white-space:pre;overflow:auto}.phase43-highlight{position:absolute;inset:0;pointer-events:none;color:#d7e1ef;background:transparent;padding:inherit;border:1px solid transparent}.phase43-code-wrap textarea{position:relative;z-index:2;color:transparent!important;caret-color:#fff;background:transparent!important;-webkit-text-fill-color:transparent}.phase43-code-wrap textarea::selection{background:rgba(90,145,255,.35);-webkit-text-fill-color:transparent}.py-key{color:#ff7ab2;font-weight:700}.py-built{color:#82d2ff}.py-fn{color:#ffd580}.py-str{color:#a8db8f}.py-num{color:#d9a6ff}.py-com{color:#7285a3;font-style:italic}.py-op{color:#8ee8de}@media(max-width:700px){.phase43-highlight{font-size:15px!important}}`;document.head.appendChild(style);
