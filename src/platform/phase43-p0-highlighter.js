...
(() => {
  ...
  const loadSingleWindow=()=>{if(!document.querySelector('link[href="phase43-single-window.css"]')){const l=document.createElement('link');l.rel='stylesheet';l.href='phase43-single-window.css';document.head.appendChild(l)}if(!document.querySelector('script[data-phase43-single-window]')&&!window.Codeopolis?.phase43SingleWindow){const s=document.createElement('script');s.src='src/platform/phase43-single-window-router.js';s.dataset.phase43SingleWindow='1';document.body.appendChild(s)}};
  setTimeout(loadSingleWindow,500);
