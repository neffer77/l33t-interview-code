(function(C){
  ...
  function edit(world,label,fn){const has=typeof world?.beginCityEdit==='function'&&typeof world?.commitCityEdit==='function';if(has)world.beginCityEdit(label);const out=fn();if(has){if(out?.ok===false)world.ensureEditState?.().tx&&(world.ensureEditState().tx=null);else world.commitCityEdit()}return out}
