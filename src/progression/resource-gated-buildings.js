(function(C){
  ...
  const GATES=Object.freeze({
    ...
    research:{minEarned:36,minDistrictLevel:2,support:{materials:12}},
  ...
  function districtLevel(state,world,id){const s=C.CurriculumDistricts?.summary?.(state,world)||{};return s.districts?.[id]?.level||0}
